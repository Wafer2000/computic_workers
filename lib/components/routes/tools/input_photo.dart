...
class _InputFotoPerfilState extends State<InputFotoPerfil> {
  ...
  Future uploadFile() async {
    ...
    if (urlDowload != null) {
      ...
      if (result != null) {
        LoadingScreen().hide();
        displayMessageToUser('Se subio correctamente la imagen', context);
        ...
        LoadingScreen().hide();
        displayMessageToUser('No se pudo subir', context);
      }
    }
    setState(() {
      _uploadTask = null;
  ...
  Future<void> _deleteImage() async {
    ...
    LoadingScreen().hide();
    displayMessageToUser('Se elimino la imagen correctamente', context);
  }
