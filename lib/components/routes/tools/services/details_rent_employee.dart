...
class DetailsRentEmployee extends StatefulWidget {
  static const String routname = '/deatils_rent_employee';
  const DetailsRentEmployee({super.key});

  @override
  State<DetailsRentEmployee> createState() => _DetailsRentEmployeeState();
}

class _DetailsRentEmployeeState extends State<DetailsRentEmployee> {
final TextEditingController tipeController = TextEditingController();
  ...
  void Actualizar() async {
    ...
    if (restecnicoController.text == '') {
      ...
      tipeController.clear();
      desmaController.clear();
      Navigator.pushNamed(context, RentEmployeeService.routname);
    }
  }
