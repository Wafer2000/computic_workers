...
class RentEmployeeService extends StatefulWidget {
  static const String routname = '/rent_employee';
  const RentEmployeeService({super.key});

  @override
  State<RentEmployeeService> createState() => _RentEmployeeServiceState();
}

class _RentEmployeeServiceState extends State<RentEmployeeService> {

  final _pref = PreferencesUser();

  String rentTag = 'rentTag';

  @override
  Widget build(BuildContext context) {
    final collections = GetCollectionsServiceWithEmployee();
    return StreamBuilder<QuerySnapshot>(
      stream: collections.getCollections('Alquiler'),
